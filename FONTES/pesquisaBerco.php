 ...
 <body class="imagem">
  ...
  ?>
   ...
   <div class="row" style="margin-left:2px; margin-right:2px;">
	...
	<center>
		<div class="row">	
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" ><font color="white"><center><b>EDITAR BERÇO</b></center></font></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <a>Deseja Realmente Remover este berço?</a>
      </div>
