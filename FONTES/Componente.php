 ...
 <body class="imagem">
  ...
  ?>
   ...
   <div class="col-lg-3 col-md-2 col-sm-2 col-xs-0"></div>
    <form class="painel col-lg-6 col-xs-10" name="pagina" method="post" action="ValidaComponente.php" >
		<div class="row form-group" style="margin-left:2px; margin-right:2px;" >

			    <div bgcolor="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  ><font color="white"><center><b>CADASTRO COMPONENTE</b></center></font></div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><font color="white"><b>Tipo de Componente:<br></b></font><select style="width: 150px;" name="tipocomponente">
					<option value="S">Caixa de som</option>
					<option value="B">Brinquedo Giratório</option>
				</select>
				</div>
